...
from bf_tap.optimization.oob_compose_growth_v30_run import cold, develop, finalize, prepare, register, run, score


DEFAULT_RUN = Path("local/runs/optimization-v0.30-oob-compose-and-time-growth-r1")
...
def main():
    ...
    actions = {
        "run": run, "register": register, "p0": prepare, "develop": develop,
