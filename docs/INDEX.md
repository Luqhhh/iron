...
| 阶段 | 冻结结果 | 阅读口径 |
| --- | --- | --- |
| v0.32 | [同铁口优先的 OOB 响应条件化](optimization_v0_32/RESULTS.md) | 0 fit；固定 v0.29 members 与每树等权，仅在原集合内同铁口优先；A/B 相对 V30A 的历史 ΔJ +0.00006051/-0.00018334；G0 PASS、两包冻结，平台反馈待回传，预算 0/2、agent 上传 0 |
